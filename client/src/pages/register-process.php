...
<head>
  ...
  <!-- Title of the page -->
  <title>Cr1pt0 Market Register</title>
</head>
...
<body>
  ...
  <div id="header">
    ...
    <nav id="nav-bar">
      ...
      <ul id="menu">
        ...
        <li><a href="login.html" class="main-nav-links">Login</a></li>
      </ul>
    </nav>
  </div>
  ...
  <section id="login-section">
    <h1 id="login-h1">Register</h1>

    <!-- Registration form -->
    <form action="register-process.php" method="post" id="loginnresgiter-form">
      <div id="form-container">
        <label for="uname" id="uname-label"><b>Username</b></label>
        <input type="text" name="uname" pattern="[A-Za-z0-9]{1,30}" class="login-input" required />

        <label for="email" class="pwd-and-remember-label"><b>Email</b></label>
        <input type="email" name="email" class="login-input" required />

        <label for="psw" class="pwd-and-remember-label">Password</label>
        <input type="password" name="psw"  class="login-input" required />

        <label for="psw" class="pwd-and-remember-label">Confirm your password</label>
        <input type="password" name="psw"  class="login-input" required />

        <!-- Age verification and terms checkbox -->
  ...
  <div id="footer">
    ...
    <div>
      <p>
        &copy; Cr1pt0 Market. All rights reserved. All trademarks are property of their respective owners in Vietnam and other countries.
      </p>
      <p>
        Some geospatial data on this website is provided by <a href="../../index.html">Cr1pt0market.org</a>.
      </p>
